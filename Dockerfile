...
# sha256sum <(NGINX_VERSION="1.19.10"; curl -s https://nginx.org/download/nginx-$NGINX_VERSION.tar.gz) | head -c 64 | pbcopy
...
RUN set -xe \
	...
	&& NGINX_SHA256="e8d0290ff561986ad7cd6c33307e12e11b137186c4403a6a5ccdb4914c082d88" \
	\
	&& apt-get update \
