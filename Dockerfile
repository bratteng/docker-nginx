...
# NGINX_VERSION="1.19.5"; curl -s https://nginx.org/download/nginx-$NGINX_VERSION.tar.gz | sha256sum | head -c 64 | pbcopy
...
RUN set -xe \
	...
	&& NGINX_SHA256="5c0a46afd6c452d4443f6ec0767f4d5c3e7c499e55a60cd6542b35a61eda799c" \
	\
	&& apt-get update \
